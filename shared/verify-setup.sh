...
required_files=(
  ...
  "$FUZZAH_REPO_ROOT/.claude/commands/fuzz-dashboard.md"
  "$FUZZAH_REPO_ROOT/.agents/skills/check-in/SKILL.md"
  "$FUZZAH_REPO_ROOT/.agents/skills/rig-check/SKILL.md"
  "$FUZZAH_REPO_ROOT/.agents/skills/fuzz-status/SKILL.md"
  "$FUZZAH_REPO_ROOT/.agents/skills/fuzz-crashes/SKILL.md"
  "$FUZZAH_REPO_ROOT/.agents/skills/fuzz-review/SKILL.md"
  "$FUZZAH_REPO_ROOT/.agents/skills/fuzz-dashboard/SKILL.md"
  "$FUZZAH_REPO_ROOT/.agents/skills/fuzz-add-target/SKILL.md"
  "$FUZZAH_REPO_ROOT/.agents/skills/fuzz-crash-review/SKILL.md"
  ...
  "$FUZZAH_SHARED_DIR/fuzz-status.sh"
