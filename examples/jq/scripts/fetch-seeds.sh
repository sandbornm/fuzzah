...
SOURCES=(
  "jq-tests|https://github.com/jqlang/jq.git|json"
  "json-test-suite|https://github.com/nst/JSONTestSuite.git|json"
  "json-test-data|https://github.com/nlohmann/json_test_data.git|json"
  "nativejson-benchmark|https://github.com/miloyip/nativejson-benchmark.git|json"
  "naughty-strings|https://github.com/minimaxir/big-list-of-naughty-strings.git|json"
)
# ────────────────────────────────────────────────────────────────────────────
